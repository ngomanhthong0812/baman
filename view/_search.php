...
<head>
    ...
    <title>Search Results for "
        <?php echo $_GET['name'] ?>" &#8211; Goldsmith &#8211; Modern WooCommerce Theme
    </title>
        ...
        <div class="max-w-[1540px] m-auto flex">
            ...
            <div class="w-[75%] pl-[1rem]">
                        ...
                        <div class="flex gap-[10px]">
                            <li class="val-1 active list-none cursor-pointer" onclick="filter(1)">
                                <svg class="svgList goldsmith-svg-icon" width="22px" height="22px"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="currentColor">
                                    <path
                                        d="M25,35.83H0V64.17H25Zm0,35.84H0V100H25ZM25,0H0V28.33H25Zm5,71.67V100h70V71.67ZM30,0V28.33h70V0Zm0,35.83V64.17h70V35.83Z">
                                    </path>
                                </svg>
                            </li>
                            <li class="val-2 list-none cursor-pointer" onclick="filter(2)">
                                <svg class="svgTwoColumn goldsmith-svg-icon" width="22px" height="22px"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="currentColor">
                            ...
                            <li class="val-3 d-none d-sm-flex list-none cursor-pointer" onclick="filter(3)">
                                <svg class="svgThreeColumn goldsmith-svg-icon" width="22px" height="22px"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 101 101.15" fill="currentColor">
                                    <path d="M100,100H70V0h30ZM30,0H0V100H30ZM65-.15H35v100H65Z"
                                        transform="translate(0.5 0.65)"></path>
                                </svg>
                            </li>
                            <li class="val-4 d-none d-lg-flex cursor-pointer" onclick="filter(4)">
                                <svg class="svgFourColumn goldsmith-svg-icon" width="22px" height="22px"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="currentColor">
                                    <path
                                        d="M21.5,0H0V100H21.5ZM100,0H78.5V100H100ZM48,0H26.5V100H48ZM74,0H52.5V100H74Z">
                                    </path>
                                </svg>
                            </li>
                ...
                <div class="relative container_filter-1">
                    ...
                    <div
                        class="product_card product_card1 grid-cols-2 w-[100%] filter-1 px-0 py-[2rem] filter-1-1 relative">
                        <div class="absolute w-[100%] is_search items-center justify-center font-black text-[15px]">
                        </div>
                        <?php foreach ($productList as $product) { ?>
                            <!-- hàm in_array Kiểm tra xem giá trị dc cung cấp ($product['name']) có tồn tại trong mảng đã cho không ($productS)-->
                            <?php if (in_array($product['name'], $productSearch)) { ?>
                                <a href="detail.php?product_id=<?php echo $product['id']; ?> "
                                    ...
                                    <div class="image w-[300px] border rounded-[5px]">
                                        ...
                                        <div class="icon"
                                            onclick="openZoomCard('<?php echo $product['image']; ?>', '<?php echo $product['name']; ?>', '<?php echo $product['price']; ?>','<?php echo $product['description']; ?>', event)">
                                    ...
                                    <div class="w-[300px]">
                                        ...
                                        <div class="view w-[100%] h-[8px] relative bg-[#e6e6e6] rounded-[5px] mt-[10px]">
                                            <div
                                                class="w-[<?php echo $product['quantity']; ?>%] h-[100%] bg-[red] rounded-l-[5px] absolute top-0 left-0">
                                            </div>
                                        </div>
                                        <div class="quantity">
                    ...
                    <!-- start lọc 2,3,4 -->
                    <div
                        class="product_card product_card2 grid-cols-2 w-[100%] filter-2 hidden px-0 py-[2rem] filter-2-1 relative">
                        <div class="absolute w-[100%] is_search items-center justify-center font-black text-[15px]">
                        </div>
                        <?php foreach ($productList as $product) { ?>
                            <?php if (in_array($product['name'], $productSearch)) { ?>
