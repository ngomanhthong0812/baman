    ...
    <div class="my_body">
            ...
            <div class="product_card">
                ...
                <?php for ($i = 0; $i < 8; $i++) { ?>
                    <a href="detail.php?product_id=<?php echo $productList[$i]['id']; ?>" class="my_card">
                        <div class="image">
                            <img src="./public/img/product/<?php echo $productList[$i]['image']; ?>.png" alt="">
        ...
        <div class="featured_Deals">
            <div class="featured_Deals-child--1">
                ...
                <div class="my_card">
                    <div class="my_card_1">
                        <img src="./public/img/product/2-2.png" alt="">
                ...
                <div class="banner_linkx">
                    <img src="./public/img/product/banner_5.png" alt="">
                    <div class="banner_ph">
                        <p>EARRINGS</p>
                ...
                <div class="banner_linkx">
                    <img src="./public/img/product/banner_6.png" alt="">
                    <div class="banner_ph">
                        <p>EARRINGS</p>
                        <h6>Create your combo now!</h6>
                    </div>
                ...
                <div class="banner_linkx">
                    <img src="./public/img/product/banner_7.png" alt="">
                    <div class="banner_ph">
                        <p>EARRINGS</p>
                        <h6>Create your combo now!</h6>
                    </div>
