...
function openZoomCard(id, image, name, price, description, event) {
  ...
  imageProduct[0].src = "./public/img/product/" + image + ".png";
  imageProduct[1].src = "./public/img/product/" + image + "-1.png";
  imageProduct[2].src = "./public/img/product/" + image + "-2.png";
  imageProduct[3].src = "./public/img/product/" + image + "-3.png";
  imageProduct[4].style.display = "block";
  imageProduct[4].src = "./public/img/product/" + image + "-4.png";

  //đổi ảnh imageChild
  imageChild[0].src = "./public/img/product/" + image + ".png";
  imageChild[1].src = "./public/img/product/" + image + "-1.png";
  imageChild[2].src = "./public/img/product/" + image + "-2.png";
  imageChild[3].src = "./public/img/product/" + image + "-3.png";
  imageChild[4].style.display = "block";
  imageChild[4].src = "./public/img/product/" + image + "-4.png";
  openZoom();
}
next_prev();
